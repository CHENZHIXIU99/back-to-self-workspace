...
function Health({data,update,notify}:{data:WorkspaceData;update:(f:(d:WorkspaceData)=>WorkspaceData)=>void;notify:(message:string)=>void}){
  ...
  <section className="panel health-summary-panel"><div className="panel-head"><div><span className="eyebrow">健康总结</span><h2>最近的生活节奏</h2></div></div><div className="summary-period-grid"><HealthSummary title="最近 7 天" summary={seven}/><HealthSummary title="最近 30 天" summary={thirty}/></div></section>
